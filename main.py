...
class ContohResource(Resource):
    def get(self):
        ...
        output = [
            {"id": movie.id, "genre": movie.genre, "judul": movie.judul, "deskripsi": movie.deskripsi}
            for movie in query
        ]
    ...
    def post(self):
        ...
        movieJudul = request.form["judul"]
        movieDeskripsi = request.form["deskripsi"]

        # masukan data ke dalam database model
        model = ModelMovie(genre=movieGenre, judul=movieJudul, deskripsi=movieDeskripsi)
        model.save()
